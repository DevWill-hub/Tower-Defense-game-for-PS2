...
import { AnimationPlayer } from "../utils/animationPlayer.js";
import { sfx } from "../core/sfx.js";

let idle1SpriteSheet = new Image("graphics/defenders/idle1_spritesheet.png");
let attack1SpriteSheet = new Image("graphics/defenders/attack1_spritesheet.png");
let laserImage = new Image("graphics/laser/laser1.png");

export default class Defender1 {
  constructor(x, y) {
    this.x = x;
    this.y = y;
    this.state = 'idle';
    ...
    this.animationPlayer = new AnimationPlayer({
      idle: new Animation(idle1SpriteSheet, [
      ...
      attack: new Animation(attack1SpriteSheet, [
        { x: 0, y: 0, width: 86, height: 69, endx: 86, endy: 69 },
        { x: 0, y: 138, width: 86, height: 69, endx: 86, endy: 207 },
        { x: 86, y: 138, width: 86, height: 69, endx: 172, endy: 207 },
