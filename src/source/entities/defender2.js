...
let idle2SpriteSheet = new Image("graphics/defenders/idle2_spritesheet.png");
let attack2SpriteSheet = new Image("graphics/defenders/attack2_spritesheet.png");
let laserImage = new Image("graphics/laser/laser2.png");
...
export default class Defender2 {
  constructor(x, y) {
    ...
    this.animationPlayer = new AnimationPlayer({
      idle: new Animation(idle2SpriteSheet, [
      ...
      attack: new Animation(attack2SpriteSheet, [
        { x: 0, y: 0, width: 86, height: 69, endx: 86, endy: 69 },
        { x: 0, y: 138, width: 86, height: 69, endx: 86, endy: 207 },
        { x: 86, y: 138, width: 86, height: 69, endx: 172, endy: 207 },
