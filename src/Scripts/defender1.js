...
let idleSpriteSheet1 = new Image("assets/Defenders/idle_spritesheet1.png");
let attackSpriteSheet1 = new Image("assets/Defenders/attack_spritesheet1.png");
let laserImage = new Image("assets/Laser/laser1.png");
...
export default class Defender1 {
  constructor(x, y) {
    ...
    this.animationPlayer = new AnimationPlayer({
      idle: new Animation(idleSpriteSheet1, [
      ...
      attack: new Animation(attackSpriteSheet1, [
        { x: 0, y: 0, width: 86, height: 69, endx: 86, endy: 69 },
        { x: 0, y: 138, width: 86, height: 69, endx: 86, endy: 207 },
        { x: 86, y: 138, width: 86, height: 69, endx: 172, endy: 207 },
